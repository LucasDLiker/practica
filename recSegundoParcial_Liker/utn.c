...
{
        printf("///////////////BIENVENIDOS////////////////\n\n");
        printf("\n1.Cargar los datos de los dominios desde el archivo data.csv\n");
        printf("2.Mapear dominios\n");
        printf("3.Filtrar dominios\n");
        printf("4.Guardar listas filtradas en los archivo auto.csv y moto.csv\n");
        printf("5.Salir\n");
}
